...
export const HeroGridCard = ({ hero }: Props) => {
  ...
  // en aplicaciones modernas de react se prefiere usar el use() en vez de usar el useContext()
  // el use() no seria un hook por lo que nos permite que lo usemos dentro de un if (con los hooks esto no se debe hacer)
  ...
  return (
    <Card className="group overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-gradient-to-br from-white to-gray-50">
      <div className="relative h-64">
        ...
        >
          <Heart className={`h-4 w-4 ${isFavorite(hero) ? 'fill-red-500 text-red-500' : 'fill-none text-gray-500'}`} />
        </Button>
